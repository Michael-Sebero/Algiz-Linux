...
Originally I was inspired by Luke Smith's [LARBS](https://github.com/LukeSmithxyz/LARBS) which is why this Algiz's installer is script-based rather than an ISO. In a way this project is like an ISO because the configuarions and original content are stored inside archives. If you want to see what changes I've made you can view them [here](https://github.com/Michael-Sebero/Algiz-Linux/tree/main/files/algiz-packages).
