...
> [!IMPORTANT]
> Depending on the distro you've choosen you may be feature limited. The only distro which contains the x86-64-v3 XanMod kernel is Artix Linux. All variants contain the same security and performance enhancements.
