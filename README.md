...
* [ALHP](https://wiki.archlinux.org/title/Unofficial_user_repositories#ALHP), [Chaotic AUR](https://github.com/chaotic-aur/packages) (for Artix and Arch) and [Flatpak](https://flatpak.org/) repositories
